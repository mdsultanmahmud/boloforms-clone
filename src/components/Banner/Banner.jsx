        ...
        <div className='min-h-screen flex items-center justify-center'>
            <div className='my-4 grid gap-5 grid-cols-1 lg:grid-cols-2'>
                <div className="mt-12">
                    ...
                    <button className="mx-auto block px-5 py-3 rounded border-2 border-[#915bff] text-[#915bff] font-bold bg-[#915bff] text-white text-2xl my-8"><FontAwesomeIcon icon={faRocket}></FontAwesomeIcon> Install For Free</button>
                </div>
                <div className="mt-4">
