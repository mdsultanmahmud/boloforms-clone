...
const Certification = () => {
    return (
        <div className='w-3/4 mx-auto shadow-2xl flex flex-col md:flex-row p-8 gap-8'>
            <div>
            ...
            <div>
                ...
                <h3 className='font-bold text-2xl text-black'>If you don’t like BoloForms over the next 30 days, I will happily refund 100% of your purchase. No questions asked.</h3>
                ...
                <img src={signature} className="w-2/4 h-[70px] ml-[-40px] mb-[-20px]" alt="" />
